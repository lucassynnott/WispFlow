...
final class WhisperManager: ObservableObject {
    ...
    /// Supported transcription languages with display names and flags
    /// Auto-detect (nil language code) is the default
    enum TranscriptionLanguage: String, CaseIterable, Identifiable, Codable {
        ...
        /// The language code to pass to WhisperKit
        /// Returns nil for auto-detect (WhisperKit will detect automatically)
